...
namespace EOSNative.Social
{
    ...
    public class EOSMatchHistory : MonoBehaviour
    {
        ...
        public void StartMatch(string gameMode = null, string mapName = null)
        {
            ...
            // Note: Replay recording integration is handled by the transport layer
            // (EOSReplayRecorder is part of FishNet transport, not the generic wrapper)
        }
        ...
        public void EndMatch(MatchOutcome outcome, string winnerPuid = null)
        {
            ...
            // Note: Replay recording stop is handled by the transport layer
