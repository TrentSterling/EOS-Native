...
#pragma warning disable CS0067 // Events are part of the public API, raised when join request system is fully implemented
...
#pragma warning restore CS0067
        ...
        [Header("Settings")]
#pragma warning disable CS0414 // Setting for future post expiry implementation
...
#pragma warning restore CS0414
        ...
        public async Task<(Result, LFGPost)> CreatePostAsync(LFGPostOptions options = null)
        {
            ...
            var post = new LFGPost
            {
                PostId = lobbyId,
                OwnerPuid = localPuid,
                OwnerName = registry?.GetPlayerName(localPuid) ?? "Unknown",
                Type = options.Type,
        ...
        private LFGPost ParseLFGPost(LobbyDetails details)
        {
            try
            {
                ...
                {
                    post.OwnerName = registry.GetPlayerName(post.OwnerPuid);
                }
