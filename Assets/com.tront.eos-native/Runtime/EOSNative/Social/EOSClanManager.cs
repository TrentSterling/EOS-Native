...
#pragma warning disable CS0067 // Events are part of the public API, raised when join/invite/request system is fully implemented
...
#pragma warning disable CS0067 // Events are part of the public API, raised when invite/request system is fully implemented
...
#pragma warning restore CS0067
        ...
        [Header("Limits")]
#pragma warning disable CS0414 // Settings for future invite/request queue limits
...
#pragma warning restore CS0414
        ...
        public async Task<(Result result, Clan clan)> CreateClanAsync(string name, string tag, string description = null)
        {
            if (IsInClan)
            {
                EOSDebugLogger.LogWarning(DebugCategory.Social, "EOSClanManager", "Already in a clan");
            ...
            var localName = EOSPlayerRegistry.Instance?.GetOrGenerateName(EOSManager.Instance.LocalProductUserId?.ToString()) ?? "Player";
        ...
        public async Task<Result> LeaveClanAsync()
        {
            ...
            {
                EOSDebugLogger.LogWarning(DebugCategory.Social, "EOSClanManager",
        ...
        public async Task<Result> InvitePlayerAsync(string targetPuid, string targetName)
        {
            ...
            var invite = new ClanInvite
            {
                ...
                InviterName = EOSPlayerRegistry.Instance?.GetOrGenerateName(EOSManager.Instance.LocalProductUserId?.ToString()) ?? "Player",
            ...
            // TODO: Send invite to target player via cloud storage or lobby attributes
        ...
        public async Task<Result> RequestJoinAsync(string clanId, string message = null)
        {
            ...
            var request = new ClanJoinRequest
            {
                ...
                RequesterName = EOSPlayerRegistry.Instance?.GetOrGenerateName(EOSManager.Instance.LocalProductUserId?.ToString()) ?? "Player",
                Message = message,
            ...
            // TODO: Send request to clan owner via cloud storage
            await Task.CompletedTask;
        ...
        public async Task<Result> SendChatAsync(string message)
        {
            ...
            var chatMessage = new ClanChatMessage
            {
                ...
                SenderName = EOSPlayerRegistry.Instance?.GetOrGenerateName(EOSManager.Instance.LocalProductUserId?.ToString()) ?? "Player",
                Message = message,
