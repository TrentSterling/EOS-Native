...
namespace EOSNative.Replay
{
    ...
    public class EOSReplayHighlights : MonoBehaviour
    {
        ...
        #region Public API - Recording Control

        /// <summary>
        /// Start highlight detection for a recording session.
        /// </summary>
        ...
        public ReplayHighlight AddHighlight(string title, HighlightType type = HighlightType.Manual)
        {
            if (!IsRecording)
            {
                EOSDebugLogger.LogWarning(DebugCategory.Replay, "EOSReplayHighlights", "Not recording");
                return null;
            }
